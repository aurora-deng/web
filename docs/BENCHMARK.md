...
本文给出实验协议和结果模板。虚拟机上一次 `GET /` 快照见 [CLOSEOUT.md](CLOSEOUT.md)；
...
它与 [ARCHITECTURE.md](ARCHITECTURE.md) 和 [TESTING.md](TESTING.md) 形成“设计假设—正确性门禁—
...
- 虚拟机快照（约 2.3 万 QPS）见 [CLOSEOUT.md](CLOSEOUT.md)；未做同机 nginx/muduo 正式对比前，
